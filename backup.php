...
backup_tables('localhost','root','','db_etms');
...
rcopy($copysql , "C:\/Users\/Stephine\/OneDrive\/ETMS Backup_Bacolod\/db_backup\/".$data);
...
rcopy($fname , "C:\/Users\/Stephine\/OneDrive\/ETMS Backup_Bacolod\/uploads\/".$zipname);
